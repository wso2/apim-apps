...
export default function ApiKeyListing({ keyType, selectedApp }) {
    ...
    const handleAssociateKey = () => {
        if (!selectedAPI) {
            alert(intl.formatMessage({ id: 'ApiKeyListing.alert.selectApi', defaultMessage: 'Please select an API first.' }));
            return;
        }
        if (!selectedExistingKey) {
            alert(intl.formatMessage({ id: 'ApiKeyListing.alert.selectKey', defaultMessage: 'Please select an existing API key to associate.' }));
            return;
        }
        const restApi = new API();
        restApi.associateAPIKeyToApp(selectedAPI, selectedExistingKey, selectedApp.appId, keyType)
            ...
            .catch((error) => {
                ...
                setAssociateErrorMessage(
                    error.response?.body?.description || intl.formatMessage({ id: 'ApiKeyListing.error.associateFailed', defaultMessage: 'Failed to associate API key. Please try again.' }),
                );
        ...
        restApi.dissociateAPIKeyFromApp(selectedApp.appId, keyType, selectedKeyForDissociate.keyUUID)
            ...
            .catch((error) => {
                ...
                setDissociateErrorMessage(
                    error.response?.body?.description || intl.formatMessage({ id: 'ApiKeyListing.error.dissociateFailed', defaultMessage: 'Failed to remove association. Please try again.' }),
                );
    ...
    const associatedKeysColumns = [
        {
            name: 'keyName',
            label: intl.formatMessage({ id: 'ApiKeyListing.column.keyName', defaultMessage: 'Key Name' }),
        },
        {
            name: 'apiName',
            label: intl.formatMessage({ id: 'ApiKeyListing.column.api', defaultMessage: 'API' }),
            options: {
        ...
        {
            name: 'issuedOn',
            label: intl.formatMessage({ id: 'ApiKeyListing.column.issuedOn', defaultMessage: 'Issued On' }),
            options: {
                customBodyRenderLite: (dataIndex) => {
                    const keyData = associatedKeysData[dataIndex];
        ...
        {
            name: 'validityPeriod',
            label: intl.formatMessage({ id: 'ApiKeyListing.column.expiresOn', defaultMessage: 'Expires On' }),
            options: {
                customBodyRenderLite: (dataIndex) => {
                    const keyData = associatedKeysData[dataIndex];
                    ...
                    if (validityPeriod === -1) {
                        return (
                            <Typography variant='body2' color='text.secondary'>
                                <FormattedMessage id='ApiKeyListing.table.never' defaultMessage='Never' />
                            </Typography>
                        );
                    }
        ...
        {
            name: 'lastUsed',
            label: intl.formatMessage({ id: 'ApiKeyListing.column.lastUsedOn', defaultMessage: 'Last Used On' }),
            options: {
                customBodyRenderLite: (dataIndex) => {
                    const keyData = associatedKeysData[dataIndex];
        ...
        {
            name: 'actions',
            label: intl.formatMessage({ id: 'ApiKeyListing.column.actions', defaultMessage: 'Actions' }),
            options: {
                sort: false,
                filter: false,
                ...
                customHeadRender: () => (
                    <TableCell align='right' className='keys-header'>
                        <FormattedMessage id='ApiKeyListing.column.actions' defaultMessage='Actions' />
                    </TableCell>
                ),
                customBodyRenderLite: (dataIndex) => {
                    const keyData = associatedKeysData[dataIndex];
                    return (
                        <Stack direction='row' spacing={1} justifyContent='flex-end'>
                            ...
                            >
                                <FormattedMessage id='ApiKeyListing.button.removeAssociation' defaultMessage='Remove Association' />
                            </Button>
                        </Stack>
                    );
                },
        ...
        <Box>
            ...
            {legacyApiKeysEnabled && (
                <Box sx={{ borderBottom: 1, borderColor: 'divider', mb: 3 }}>
                    <Tabs value={currentTab} onChange={handleTabChange}>
                        <Tab label={intl.formatMessage({ id: 'ApiKeyListing.tab.apiKeys', defaultMessage: 'API Keys' })} />
                        <Tab label={intl.formatMessage({ id: 'ApiKeyListing.tab.legacyApiKeys', defaultMessage: 'Legacy API Keys' })} />
                    </Tabs>
                </Box>
            )}
            ...
            {(!legacyApiKeysEnabled || currentTab === 0) && (
                <Stack spacing={4}>
                        ...
                        <Grid container spacing={3}>
                            <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 4, gap: 2 }}>
                                ...
                                <Typography variant='body1' color='text.secondary'>
                                    <FormattedMessage id='ApiKeyListing.loading' defaultMessage='Loading API key associations...' />
                                </Typography>
                            </Grid>
                        </Grid>
                        ...
                        <Grid container spacing={3}>
                            <Grid item xs={12} sx={{ textAlign: 'center', mt: 4, p: 2, color: 'text.secondary' }}>
                                <Typography variant='h5' gutterBottom>
                                    <FormattedMessage id='ApiKeyListing.empty.title' defaultMessage='No API Keys Found' />
                                </Typography>
                                <Typography variant='subtitle1' gutterBottom sx={{ mb: 3 }}>
                                    <FormattedMessage id='ApiKeyListing.empty.subtitle' defaultMessage='Get started by associating an existing API key with your subscribed APIs.' />
                                </Typography>
                                <Button
                                    variant='contained'
                                    color='primary'
                                ...
                                >
                                    <FormattedMessage id='ApiKeyListing.button.associateApiKey' defaultMessage='Associate API Key' />
                                </Button>
                            </Grid>
                        </Grid>
                    ) : (
                                ...
                                <Box display='flex' justifyContent='space-between' alignItems='center'>
                                    <Box>
                                        <Typography variant='h5' sx={{ fontWeight: 600 }}>
                                            <FormattedMessage id='ApiKeyListing.title' defaultMessage='API Keys' />
                                        </Typography>
                                        <Typography variant='body2' color='text.secondary' sx={{ mt: 0.5 }}>
                                            <FormattedMessage id='ApiKeyListing.subtitle' defaultMessage='View and manage API keys that have been associated with APIs from this application.' />
                                        </Typography>
                                    </Box>
                                    <Button
                                        variant='contained'
                    ...
                    >
                        <DialogTitle>
                            <FormattedMessage id='ApiKeyListing.modal.associate.title' defaultMessage='Associate Existing API Key' />
                            <Typography variant='body2' color='text.secondary'>
                                <FormattedMessage id='ApiKeyListing.modal.associate.subtitle' defaultMessage='Associate an existing API key from your subscribed APIs to this application.' />
                            </Typography>
                        </DialogTitle>
                        <DialogContent>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6}>
                                        <FormControl size='small' fullWidth disabled={associateLoading}>
                                            <InputLabel><FormattedMessage id='ApiKeyListing.field.selectApi.label' defaultMessage='Select API' /></InputLabel>
                                            <Select
                                                value={selectedAPI}
                                                label={intl.formatMessage({ id: 'ApiKeyListing.field.selectApi.label', defaultMessage: 'Select API' })}
                                                onChange={(e) => {
                                            ...
                                            >
                                                {uniqueSubscribedAPIs.length === 0 && !associateLoading && (
                                                    <MenuItem disabled value=''>
                                                        <FormattedMessage id='ApiKeyListing.select.noSubscribedApis' defaultMessage='No subscribed APIs found' />
                                                    </MenuItem>
                                                )}
                                    ...
                                    <Grid item xs={6}>
                                        <FormControl size='small' fullWidth disabled={!selectedAPI || associateLoading}>
                                            <InputLabel><FormattedMessage id='ApiKeyListing.field.selectExistingKey.label' defaultMessage='Select Existing API Key' /></InputLabel>
                                            <Select
                                                value={selectedExistingKey}
                                                label={intl.formatMessage({ id: 'ApiKeyListing.field.selectExistingKey.label', defaultMessage: 'Select Existing API Key' })}
                                                onChange={(e) => setSelectedExistingKey(e.target.value)}
                                            >
                                                {keysForSelectedAPI.length === 0 && selectedAPI && (
                                                    <MenuItem disabled value=''>
                                                        <FormattedMessage id='ApiKeyListing.select.noKeysForApi' defaultMessage='No API keys available for this API' />
                                                    </MenuItem>
                                                )}
                                    ...
                                    {associateLoading && (
                                        <Grid item xs={12} sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                            ...
                                            <Typography variant='caption' color='text.secondary'>
                                                <FormattedMessage id='ApiKeyListing.loading.subscribedApis' defaultMessage='Loading subscribed APIs and keys...' />
                                            </Typography>
                                        </Grid>
                                    )}
                                    {!associateLoading && selectedAPI && keysForSelectedAPI.length === 0 && (
                                        <Grid item xs={12}>
                                            <Typography variant='caption' color='text.secondary' sx={{ fontStyle: 'italic' }}>
                                                <FormattedMessage id='ApiKeyListing.caption.noKeysAvailable' defaultMessage='No API keys are available to associate with this API' />
                                            </Typography>
                                        </Grid>
                                    )}
                                    {!associateLoading && selectedAPI && keysForSelectedAPI.length > 0 && !selectedExistingKey && (
                                        <Grid item xs={12}>
                                            <Typography variant='caption' color='text.secondary' sx={{ fontStyle: 'italic' }}>
                                                <FormattedMessage id='ApiKeyListing.caption.selectKeyInstruction' defaultMessage='Select an API key to associate with the selected API' />
                                            </Typography>
                                        </Grid>
                                    )}
                                </Grid>
                        ...
                        <DialogActions>
                            <Button onClick={handleCloseAssociateModal}>
                                <FormattedMessage id='ApiKeyListing.button.cancel' defaultMessage='Cancel' />
                            </Button>
                            <Button
            ...
            >
                <DialogTitle>
                    <FormattedMessage id='ApiKeyListing.dissociateConfirm.title' defaultMessage='Confirm Remove Association' />
                </DialogTitle>
                <DialogContent>
                    <Typography>
                        <FormattedMessage id='ApiKeyListing.dissociateConfirm.message' defaultMessage='Are you sure you want to remove this API key association?' />
                    </Typography>
                </DialogContent>
                <DialogActions>
            ...
            >
                <DialogTitle>
                    <FormattedMessage id='ApiKeyListing.dissociateSuccess.title' defaultMessage='Association Removed' />
                </DialogTitle>
                <DialogContent>
                    <Alert severity='success' sx={{ mb: 1 }}>
                        <FormattedMessage id='ApiKeyListing.dissociateSuccess.message' defaultMessage='API key association has been successfully removed.' />
                    </Alert>
                </DialogContent>
                <DialogActions>
                    <Button
                        ...
                        variant='contained'
                    >
                        <FormattedMessage id='ApiKeyListing.button.ok' defaultMessage='OK' />
                    </Button>
                </DialogActions>
            </Dialog>
            ...
            >
                <DialogTitle>
                    <FormattedMessage id='ApiKeyListing.dissociateError.title' defaultMessage='Remove Association Failed' />
                </DialogTitle>
                <DialogContent>
                    <Typography>
            ...
            >
                <DialogTitle>
                    <FormattedMessage id='ApiKeyListing.associateSuccess.title' defaultMessage='Association Successful' />
                </DialogTitle>
                <DialogContent>
                    <Alert severity='success' sx={{ mb: 1 }}>
                        <FormattedMessage id='ApiKeyListing.associateSuccess.message' defaultMessage='API key has been successfully associated with the application.' />
                    </Alert>
                </DialogContent>
                <DialogActions>
                    <Button
            ...
            >
                <DialogTitle>
                    <FormattedMessage id='ApiKeyListing.associateError.title' defaultMessage='Association Failed' />
                </DialogTitle>
                <DialogContent>
                    <Typography>
