                            ...
                            <Grid container justifyContent="center" alignItems="center" rowSpacing={3} columnSpacing={3} >
                                {filteredLanguageList.map((language) => (
                                    <Grid key={language} item>
                                        <div style={{ width: 'auto', textAlign: 'center', margin: '10px', display: 'flex',
                                                ...
                                                {languagesWithCodeDownload.includes(language.toLowerCase()) ? (
                                                    <>
                                                        ...
                                                        <div style={{ 
                                                            ...
                                                            <Tooltip title="Download sample code" arrow>
                                                                <IconButton
                                                                    size="medium"
                    ...
                    >
                        ...
                        <Box sx={{ 
                            ...
                            <Typography variant="body2" color="text.secondary" sx={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                defaultMessage: 'The sample application code is generated using AI technology and is only provided as a starting point for development.'
                                })}
                            </Typography>
                        </Box>
                    </DialogContent>
