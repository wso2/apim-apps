        ...
        restApi.associateApiApiKey(apiUUID, keyUUID, applicationUUID)
            ...
            .catch((error) => {
                ...
                setAssociateErrorMessage(
                    ...
                    || intl.formatMessage({
                        id: 'ApiKeyAssociation.error.associateFailed',
        ...
        restApi.dissociateApiApiKey(apiUUID, selectedKeyForDissociate.keyUUID)
            ...
            .catch((error) => {
                ...
                setDissociateErrorMessage(
                    error.response?.body?.description
                    || intl.formatMessage({
                        id: 'ApiKeyAssociation.error.dissociateFailed',
        ...
        <>
            ...
            >
                ...
                <DialogContent>
                    <Typography sx={{ mb: 2 }}>
                        <FormattedMessage
                            id='ApiKeyAssociation.modal.associate.body'
                    ...
                    <FormControl fullWidth>
                        <InputLabel>
                            <FormattedMessage
                                id='ApiKeyAssociation.field.application.label'
            ...
            >
                ...
                <DialogContent>
                    <Typography>
                        <FormattedMessage
                            id='ApiKeyAssociation.associateSuccess.message'
            ...
            >
                ...
                <DialogContent>
                    <Typography>
                        <FormattedMessage
                            id='ApiKeyAssociation.dissociateConfirm.message'
            ...
            >
                ...
                <DialogContent>
                    <Typography>
                        <FormattedMessage
                            id='ApiKeyAssociation.dissociateSuccess.message'
