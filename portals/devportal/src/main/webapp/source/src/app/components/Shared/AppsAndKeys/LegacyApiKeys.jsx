...
export default function LegacyApiKeys({ keyType, selectedApp }) {
    ...
    const restrictionOptions = [
        { value: 'none', label: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.restriction.none.label', defaultMessage: 'None' }), description: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.restriction.none.description', defaultMessage: 'No restrictions applied' }) },
        { value: 'ip', label: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.restriction.ip.label', defaultMessage: 'Preferred IP' }), description: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.restriction.ip.description', defaultMessage: 'Restrict by IP address' }) },
        { value: 'referrer', label: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.restriction.referrer.label', defaultMessage: 'Preferred Referrer' }), description: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.restriction.referrer.description', defaultMessage: 'Restrict by HTTP referrer' }) },
    ];
    ...
    const handleConfirmRevoke = () => {
        ...
        restApi.revokeAppBoundAPIKey(selectedApp.appId, keyType, selectedKeyForRevoke.keyUUID)
            ...
            .catch((error) => {
                ...
                setRevokeErrorMessage(error.message || intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.error.revokeFailed', defaultMessage: 'Failed to revoke API key. Please try again.' }));
    ...
    const handleRegenerateKey = (keyData) => {
        ...
        restApi.regenerateAppBoundAPIKey(selectedApp.appId, keyType, keyData.keyUUID)
            ...
            .catch((error) => {
                ...
                setRegenerateErrorMessage(error.message || intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.error.regenerateFailed', defaultMessage: 'Failed to regenerate API key. Please try again.' }));
    ...
    const legacyKeysColumns = [
        ...
        {
            name: 'issuedOn',
            label: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.column.issuedOn', defaultMessage: 'Issued On' }),
            options: {
        ...
        {
            name: 'validityPeriod',
            label: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.column.expiresOn', defaultMessage: 'Expires On' }),
            options: {
                customBodyRenderLite: (dataIndex) => {
                    const keyData = legacyKeysData[dataIndex];
        ...
        {
            name: 'lastUsed',
            label: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.column.lastUsedOn', defaultMessage: 'Last Used On' }),
            options: {
                customBodyRenderLite: (dataIndex) => {
                    const keyData = legacyKeysData[dataIndex];
        ...
        {
            name: 'actions',
            label: intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.column.actions', defaultMessage: 'Actions' }),
            options: {
                sort: false,
                filter: false,
                ...
                customHeadRender: () => (
                    <TableCell align='right' className='keys-header'>
                        <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.column.actions' defaultMessage='Actions' />
                    </TableCell>
                ),
                customBodyRenderLite: (dataIndex) => {
                    const keyData = legacyKeysData[dataIndex];
                    return (
                        <Stack direction='row' spacing={1} justifyContent='flex-end'>
                            ...
                            >
                                <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.revoke' defaultMessage='Revoke' />
                            </Button>
                            <Button
                                variant='outlined'
                                size='small'
                            ...
                            >
                                <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.regenerate' defaultMessage='Regenerate' />
                            </Button>
                        </Stack>
                    );
                },
    ...
    return (
        <Stack spacing={4}>
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 4, gap: 2 }}>
                        ...
                        <Typography variant='body1' color='text.secondary'>
                            <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.loading' defaultMessage='Loading legacy API keys...' />
                        </Typography>
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sx={{ textAlign: 'center', mt: 4, p: 2, color: 'text.secondary' }}>
                        <Typography variant='h5' gutterBottom>
                            <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.empty.title' defaultMessage='No Legacy API Keys Found' />
                        </Typography>
                        <Typography variant='subtitle1' gutterBottom sx={{ mb: 3 }}>
                            <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.empty.subtitle' defaultMessage='Generate your first legacy API key to access your subscribed APIs from this application.' />
                        </Typography>
                        <Button
                            variant='contained'
                            color='primary'
                        ...
                        >
                            <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.generate' defaultMessage='Generate Legacy API Key' />
                        </Button>
                    </Grid>
                </Grid>
            ) : (
                        ...
                        <Box display='flex' justifyContent='space-between' alignItems='center'>
                            <Box>
                                <Typography variant='h5' sx={{ fontWeight: 600 }}>
                                    <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.title' defaultMessage='Legacy API Keys' />
                                </Typography>
                                <Typography variant='body2' color='text.secondary' sx={{ mt: 0.5 }}>
                                    <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.subtitle' defaultMessage='Manage legacy API keys generated for your Applications.' />
                                </Typography>
                            </Box>
                            <Button
                                variant='contained'
            ...
            >
                <DialogTitle>
                    <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.modal.generate.title' defaultMessage='Generate Legacy API Key' />
                    <Typography variant='body2' color='text.secondary'>
                        <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.modal.generate.subtitle' defaultMessage='Create a new legacy API key for this application to access your subscribed APIs.' />
                    </Typography>
                </DialogTitle>
                <DialogContent>
                    <Stack spacing={3} padding={2}>
                        <Grid container spacing={2}>
                            <Grid item xs={12}>
                                <TextField
                                    size='small'
                                    label={intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.field.name.label', defaultMessage: 'Name' })}
                                    value={displayName}
                                    onChange={(e) => setDisplayName(e.target.value)}
                                    placeholder={intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.field.name.placeholder', defaultMessage: 'Enter a name for this API key' })}
                                    fullWidth
                                />
                            </Grid>
                            <Grid item xs={6}>
                                <FormControl size='small' fullWidth>
                                    <InputLabel><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.field.validityPeriod.label' defaultMessage='Validity Period' /></InputLabel>
                                    <Select
                                        value={validityPeriod}
                                        label={intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.field.validityPeriod.label', defaultMessage: 'Validity Period' })}
                            ...
                            {validityPeriod === 'custom' && (
                                <Grid item xs={6}>
                                    <TextField
                                        size='small'
                                        fullWidth
                                        label={intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.field.days.label', defaultMessage: 'Days' })}
                                        type='number'
                                        value={customValidityDays}
                                        onChange={(e) => setCustomValidityDays(e.target.value)}
                                        placeholder={intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.field.days.placeholder', defaultMessage: 'Enter days' })}
                                    />
                                </Grid>
                            )}
                            <Grid item xs={validityPeriod === 'custom' ? 6 : 6}>
                                <FormControl size='small' fullWidth>
                                    <InputLabel><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.field.securityRestriction.label' defaultMessage='Security Restriction' /></InputLabel>
                                    <Select
                                        value={restrictionType}
                                        label={intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.field.securityRestriction.label', defaultMessage: 'Security Restriction' })}
                                        onChange={(e) => {
                ...
                <DialogActions>
                    <Button onClick={handleCloseLegacyModal}>
                        <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.cancel' defaultMessage='Cancel' />
                    </Button>
                    <Button
            ...
            <Dialog
                ...
                fullWidth
            >
                <DialogTitle><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.generatedKey.title' defaultMessage='API Key Generated Successfully' /></DialogTitle>
                <DialogContent>
                        ...
                        {showToken && generatedApiKey && (
                            <>
                                ...
                                <Box sx={{ mt: 1 }}>
                                    ...
                                    >
                                        <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.keyLabel' defaultMessage='API Key' />
                                        {' - '}
                                        <Typography
                                            component='span'
                                            variant='subtitle2'
                                        ...
                                        InputProps={{
                                            ...
                                            endAdornment: (
                                                <InputAdornment position='end'>
                                                    <Tooltip title={intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.tooltip.copyToClipboard', defaultMessage: 'Copy to clipboard' })} placement='top'>
                                                        <IconButton
                                                            aria-label={intl.formatMessage({ id: 'Shared.AppsAndKeys.LegacyApiKeys.tooltip.copyToClipboard', defaultMessage: 'Copy to clipboard' })}
                                                            onClick={() => {
                                    ...
                                    <FormHelperText sx={{ mt: 0.75, fontSize: '0.75rem' }}>
                                        <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.validityHelperText' defaultMessage='Above API Key has a validity period of' />
                                        {' '}
                                        <strong>
                                            {generatedApiKey.validityPeriod === -1
                                                ? <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.validity.neverExpires' defaultMessage='Never Expires' />
                                                : <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.validity.seconds' defaultMessage='{seconds} seconds' values={{ seconds: generatedApiKey.validityPeriod }} />}
                                        </strong>
                                        .
                                    </FormHelperText>
                                </Box>
                ...
                <DialogActions>
                    <Button onClick={handleCloseGeneratedKeyModal} variant='contained'>
                        <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.close' defaultMessage='Close' />
                    </Button>
                </DialogActions>
            </Dialog>
            ...
            <Dialog open={revokeConfirmOpen} onClose={handleCancelRevoke} maxWidth='xs' fullWidth>
                <DialogTitle><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.revokeConfirm.title' defaultMessage='Confirm Revoke' /></DialogTitle>
                <DialogContent>
                    <Typography>
                        <FormattedMessage
                            id='Shared.AppsAndKeys.LegacyApiKeys.revokeConfirm.message'
                ...
                <DialogActions>
                    <Button onClick={handleCancelRevoke}><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.cancel' defaultMessage='Cancel' /></Button>
            ...
            <Dialog open={revokeSuccessOpen} onClose={handleCloseRevokeSuccess} maxWidth='xs' fullWidth>
                <DialogTitle><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.revokeSuccess.title' defaultMessage='API Key Revoked' /></DialogTitle>
                <DialogContent>
                    <Typography><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.revokeSuccess.message' defaultMessage='The API key has been successfully revoked.' /></Typography>
                </DialogContent>
                <DialogActions>
                    <Button onClick={handleCloseRevokeSuccess} variant='contained'><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.ok' defaultMessage='OK' /></Button>
                </DialogActions>
            </Dialog>

            {/* Revoke Error Dialog */}
            <Dialog open={revokeErrorOpen} onClose={handleCloseRevokeError} maxWidth='xs' fullWidth>
                <DialogTitle><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.revokeError.title' defaultMessage='Revoke Failed' /></DialogTitle>
                <DialogContent>
                    <Typography>{revokeErrorMessage}</Typography>
                </DialogContent>
                <DialogActions>
                    <Button onClick={handleCloseRevokeError} variant='contained'><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.ok' defaultMessage='OK' /></Button>
                </DialogActions>
            </Dialog>
            ...
            <Dialog
                ...
                fullWidth
            >
                <DialogTitle><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.regenerateKey.title' defaultMessage='API Key Regenerated Successfully' /></DialogTitle>
                <DialogContent>
                    <Stack spacing={2} sx={{ pt: 1 }}>
                        {regeneratedApiKey && (
                            <>
                                    ...
                                    <FormHelperText sx={{ mt: 0.75, fontSize: '0.75rem' }}>
                                        ...
                                        <strong>
                                            {regeneratedApiKey.validityPeriod === -1
                                                ? <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.validity.neverExpires' defaultMessage='Never Expires' />
                                                : <FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.validity.seconds' defaultMessage='{seconds} seconds' values={{ seconds: regeneratedApiKey.validityPeriod }} />}
                                        </strong>
                                        .
                                    </FormHelperText>
                                </Box>
                ...
                <DialogActions>
                    <Button onClick={handleCloseRegenerateModal} variant='contained'><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.close' defaultMessage='Close' /></Button>
                </DialogActions>
            </Dialog>

            {/* Regenerate Error Dialog */}
            <Dialog open={regenerateErrorOpen} onClose={handleCloseRegenerateError} maxWidth='xs' fullWidth>
                <DialogTitle><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.regenerateError.title' defaultMessage='Regenerate Failed' /></DialogTitle>
                <DialogContent>
                    <Typography>{regenerateErrorMessage}</Typography>
                </DialogContent>
                <DialogActions>
                    <Button onClick={handleCloseRegenerateError} variant='contained'><FormattedMessage id='Shared.AppsAndKeys.LegacyApiKeys.button.ok' defaultMessage='OK' /></Button>
                </DialogActions>
            </Dialog>
        </Stack>
    );
