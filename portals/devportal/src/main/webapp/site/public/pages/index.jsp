...
<html lang="en">
    <%
        ...
        Map manifest = Util.readJsonFile("/site/public/dist/manifest.json", request.getServletContext());
        String indexKey = "index.js";
        String indexBundlePath = (String) manifest.get(indexKey);
        String indexBundle = indexBundlePath.split("dist/")[1];
    %>
    <head>
        <base href="<%= context%>/" />
        <meta charset="utf-8">
