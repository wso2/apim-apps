...
const ExternalStoreURL = (props) => {
    ...
    return (
        <TextField
            label={(
                <FormattedMessage
                    id='Apis.Details.Configuration.components.ExternalStoreURL.externalStoreURL'
            ...
            onChange={(e) => configDispatcher({
                action: 'advertiseInfo',
                value: e.target.value,
            })}
            disabled={isRestricted(['apim:api_create', 'apim:api_publish'], apiFromContext)}
            helperText={(
                <FormattedMessage
                    id='Apis.Details.Configuration.components.ExternalStoreURL.externalStoreURL.help'
...
export default React.memo(ExternalStoreURL);
