...
const OperationPolicy: FC<OPProps> = ({ operation, operationsDispatcher, highlight, api, disableUpdate,
    spec, target, verb, expandedResource, setExpandedResource }) => {
        ...
        const [addPolicy, setAddPolicy] = useState<Policy>({id:0, policy: "", description: "", flows: [], isDone: false});
        const [selectedPolicy, setSelectedPolicy] = useState<Policy>({id:0, policy: "", description: "", flows: [], isDone: false});
        ...
        const onDragEnd = (result: DropResult) => {
          ...
          let requestFlowPolicies = RequestFlowPolicies;
          let responseFlowPolicies = ResponseFlowPolicies;
          let faultFlowPolicies = FaultFlowPolicies;
          // Source Logic
          ...
          let msg = "Configure " + add.policy + " Policy";
