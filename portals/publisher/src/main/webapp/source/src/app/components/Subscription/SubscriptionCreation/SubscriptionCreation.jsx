    ...
    return (
        <WorkflowApprovalTasks
            ...
            title={intl.formatMessage({
                id: 'Subscription.SubscriptionCreation.SubscriptionCreation.subscription.creation.title',
            ...
            searchPlaceholder={intl.formatMessage({
                id: 'Subscription.SubscriptionCreation.SubscriptionCreation.subscription.creation.search.default',
