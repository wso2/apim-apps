...
function ListLabels() {
    ...
    function apiCall() {
        return restApi
            .workflowsGet('AM_API_PRODUCT_STATE')
            .then((result) => {
                const workflowlist = result.body.list.map((obj) => {
                    return {
                        description: obj.description,
                        apiProduct: obj.properties.apiName,
        ...
        return promisedupdateWorkflow
            .then(() => {
                ...
                Alert.success(intl.formatMessage({
                    id: 'Workflow.APIProductStateChange.update.success',
    ...
    const pageProps = {
                    ...
                    <ListItem button>
                        ...
                        >
                            <ListItemText primary={(
                                <FormattedMessage
                                    id='Workflow.APIProductStatechange.help.link.one'
                                    defaultMessage='Create a API Product State change approval workflow request'
                                />
                            )}
                            />
                        </Link>
        ...
        title: intl.formatMessage({
            id: 'Workflow.APIProductStateChange.title.api.product.state.change',
    ...
    const columProps = [
        {
            ...
            label: intl.formatMessage({
                id: 'Workflow.APIProductStateChange.table.header.Description',
        ...
        },
        {
            name: 'apiProduct',
            label: intl.formatMessage({
                id: 'Workflow.APIProductStateChange.table.header.APIName',
        ...
        },
        {
            name: 'action',
            label: intl.formatMessage({
                id: 'Workflow.APIProductStateChange.table.header.RequestState',
        ...
        },
        {
            name: 'currentState',
            label: intl.formatMessage({
                id: 'Workflow.APIProductStateChange.table.header.CurrentState',
        ...
        },
        {
            name: 'apiProvider',
            label: intl.formatMessage({
                id: 'Workflow.APIProductStateChange.table.header.ApiProductProvider',
        ...
        },
        {
            name: 'action',
            label: intl.formatMessage({
                id: 'Workflow.APIProductStateChange.table.header.Action',
                        ...
                        <div>
                            <Box component='span' m={1}>
                                ...
                                >
                                    <CheckIcon />
                                    <FormattedMessage
                                        id='Workflow.APIProductStateChange.table.button.approve'
                                ...
                                >
                                    <ClearIcon />
                                    <FormattedMessage
                                        id='Workflow.APIProductStateChange.table.button.reject'
    ...
    const searchPlaceholder = intl.formatMessage({
        id: 'Workflow.apiProduct.state.change.search.default',
                ...
                <Card className={classes.root}>
                    <CardContent>
                        <Typography gutterBottom variant='h5' component='h2'>
                            <FormattedMessage
                                id='Workflow.APIProductStateChange.List.empty.title.apiProduct.state.change'
                                defaultMessage='API Product State Change'
                            />
                        </Typography>
                        <Typography variant='body2' color='textSecondary' component='p'>
                            <FormattedMessage
                                id='Workflow.APIProductStateChange.List.empty.content.apiProduct.state.change'
                                defaultMessage='There are no pending workflow requests for API Product state change.'
                            />
                        </Typography>
                    </CardContent>
                    <CardActions>
    ...
    if (!hasListPermission) {
        return (
            <WarningBase
                ...
                title={(
                    <FormattedMessage
                        id='Workflow.ApiProductStateChange.permission.denied.title'
                        defaultMessage='Permission Denied'
                    />
                )}
                content={(
                    <FormattedMessage
                        id='Workflow.ApiProductStateChange.permission.denied.content'
