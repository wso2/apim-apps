...
function ListLabels() {
    ...
    function apiCall() {
        return restApi
            .workflowsGet('AM_SUBSCRIPTION_DELETION')
            .then((result) => {
            ...
            .catch((error) => {
                ...
                if (status === 401) {
                    ...
                    Alert.error(intl.formatMessage({
                        id: 'Workflow.SubscriptionDeletion.apicall.has.errors',
                        defaultMessage: 'Unable to get workflow pending requests for Subscription Deletion',
                    }));
                    throw (error);
                }
            });
        ...
        return promisedupdateWorkflow
            .then(() => {
                ...
                Alert.success(intl.formatMessage({
                    id: 'Workflow.SubscriptionDeletion.update.success',
            ...
            .catch((error) => {
                ...
                if (status === 401) {
                    ...
                    Alert.error(intl.formatMessage({
                        id: 'Workflow.SubsriptionDeletion.updateStatus.has.errors',
                        defaultMessage: 'Unable to complete subscription deletion approve/reject process. ',
                    }));
                    ...
                    <ListItem button>
                        ...
                        >
                            <ListItemText primary={(
                                <FormattedMessage
                                    id='Workflow.SubscriptionDeletion.help.link.one'
                                    defaultMessage='Create a subscription deletion request'
                                />
                            )}
                            />
                        </Link>
    ...
    const columProps = [
        {
            ...
            label: intl.formatMessage({
                id: 'Workflow.SubscriptionDeletion.table.header.Description',
        ...
        },
        {
            name: 'api',
            label: intl.formatMessage({
                id: 'Workflow.SubscriptionDeletion.table.header.API',
                defaultMessage: 'API',
            }),
            options: {
                sort: false,
        ...
        },
        {
            ...
            label: intl.formatMessage({
                id: 'Workflow.SubscriptionDeletion.table.header.Application',
        ...
        },
        {
            name: 'subscriber',
            label: intl.formatMessage({
                id: 'Workflow.SubscriptionDeletion.table.header.Subscriber',
        ...
        },
        {
            name: 'action',
            label: intl.formatMessage({
                id: 'Workflow.SubscriptionDeletion.table.header.Action',
                        ...
                        <div>
                            <Box component='span' m={1}>
                                ...
                                >
                                    <CheckIcon />
                                    <FormattedMessage
                                        id='Workflow.SubscriptionDeletion.table.button.approve'
                                ...
                                >
                                    <ClearIcon />
                                    <FormattedMessage
                                        id='Workflow.SubscriptionDeletion.table.button.reject'
                ...
                <Card className={classes.root}>
                    <CardContent>
                        <Typography gutterBottom variant='h5' component='h2'>
                            <FormattedMessage
                                id='Workflow.SubscriptionDeletion.List.empty.title.subscriptiondeletions'
                                defaultMessage='Subscription Deletion'
                            />
                        </Typography>
                        <Typography variant='body2' color='textSecondary' component='p'>
                            <FormattedMessage
                                id='Workflow.SubscriptionDeletion.List.empty.content.subscriptiondeletions'
                                defaultMessage='There are no pending workflow requests for subscription deletion.'
                            />
                        </Typography>
                    </CardContent>
                    <CardActions>
    ...
    if (!hasListPermission) {
        return (
            <WarningBase
                ...
                title={(
                    <FormattedMessage
                        id='Workflow.SubscriptionDeletion.permission.denied.title'
                        defaultMessage='Permission Denied'
                    />
                )}
                content={(
                    <FormattedMessage
                        id='Workflow.SubscriptionDeletion.permission.denied.content'
                        defaultMessage={'You dont have enough permission to view Subscription Deletion - '
