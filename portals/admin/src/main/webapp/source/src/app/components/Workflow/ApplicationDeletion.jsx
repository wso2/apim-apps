...
function ListLabels() {
    ...
    function apiCall() {
        return restApi
            .workflowsGet('AM_APPLICATION_DELETION')
            .then((result) => {
            ...
            .catch((error) => {
                ...
                if (status === 401) {
                    ...
                    Alert.error(intl.formatMessage({
                        id: 'Workflow.ApplicationDeletion.apicall.has.errors',
                        defaultMessage: 'Unable to get workflow pending requests for Application Deletion',
                    }));
                    throw (error);
                }
            });
        ...
        return promisedupdateWorkflow
            .then(() => {
                ...
                Alert.success(intl.formatMessage({
                    id: 'Workflow.ApplicationDeletion.update.success',
            ...
            .catch((error) => {
                ...
                if (status === 401) {
                    ...
                    Alert.error(intl.formatMessage({
                        id: 'Workflow.ApplicationDeletion.updateStatus.has.errors',
                    ...
                    <ListItem button>
                        ...
                        >
                            <ListItemText primary={(
                                <FormattedMessage
                                    id='Workflow.ApplicationDeletion.help.link.one'
    ...
    const columProps = [
        {
            ...
            label: intl.formatMessage({
                id: 'Workflow.ApplicationDeletion.table.header.description',
        ...
        },
        {
            ...
            label: intl.formatMessage({
                id: 'Workflow.ApplicationDeletion.table.header.applicationName',
        ...
        },
        {
            ...
            label: intl.formatMessage({
                id: 'Workflow.ApplicationDeletion.table.header.ApplicationTier',
        ...
        },
        {
            name: 'userName',
            label: intl.formatMessage({
                id: 'Workflow.ApplicationDeletion.table.header.userName',
        ...
        },
        {
            name: 'action',
            label: intl.formatMessage({
                id: 'Workflow.ApplicationDeletion.table.header.Action',
                        ...
                        <div>
                            <Box component='span' m={1}>
                                ...
                                >
                                    <CheckIcon />
                                    <FormattedMessage
                                        id='Workflow.ApplicationDeletion.table.button.approve'
                                ...
                                >
                                    <ClearIcon />
                                    <FormattedMessage
                                        id='Workflow.ApplicationDeletion.table.button.reject'
                ...
                <Card className={classes.root}>
                    <CardContent>
                        <Typography gutterBottom variant='h5' component='h2'>
                            <FormattedMessage
                                id='Workflow.ApplicationDeletion.List.empty.title.applicationdeletions'
                                defaultMessage='Application Deletion'
                            />
                        </Typography>
                        <Typography variant='body2' color='textSecondary' component='p'>
                            <FormattedMessage
                                id='Workflow.ApplicationDeletion.List.empty.content.applicationdeletions'
    ...
    if (!hasListPermission) {
        return (
            <WarningBase
                ...
                title={(
                    <FormattedMessage
                        id='Workflow.ApplicationDeletion.permission.denied.title'
                        defaultMessage='Permission Denied'
                    />
                )}
                content={(
                    <FormattedMessage
                        id='Workflow.ApplicationDeletion.permission.denied.content'
