...
function ListLabels() {
    ...
    return (
        <WorkflowApprovalTasks
            workflowTypes={['AM_APPLICATION_UPDATE']}
            title={intl.formatMessage({
                id: 'Workflow.ApplicationUpdate.application.update.title',
            ...
            searchPlaceholder={intl.formatMessage({
                id: 'Workflow.ApplicationUpdate.application.update.search.default',
