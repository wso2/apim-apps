...
class APIDefinitionPage extends PublisherComonPage{

    static importDefinitionButton(){
        return cy.get('#import-definition-btn')
    }   
   ...
   static  waitUntilGetUrlValidatedDiv(timeoutInMs){
    ...
    static editAndImportButton(){
        return cy.get('#import-before-edit-btn')
    } 
    static linterResultUIDiv(){
        return cy.get('[data-testid="testid-linter-ui"]')
    } 
