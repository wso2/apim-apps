...
describe("Add Edit Delete Microgateway Environments", () => {
    ...
    it("Add Edit Delete Microgateway Environments", () => {
        ...
        cy.wait('@environmentsGet', { timeout: Cypress.config("defaultCommandTimeout") }).then(() => {
        ...
        cy.wait('@environmentsGetAfterEdit', { timeout: Cypress.config("defaultCommandTimeout") }).then(() => {
