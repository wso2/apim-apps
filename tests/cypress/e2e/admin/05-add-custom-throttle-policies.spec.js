...
describe("Add custom throttle policies", () => {
    ...
    it.only("Add custom throttle policies",{
        ...
        cy.get('[data-testid="Custom Policies-child-link"]', {timeout: Cypress.config("defaultCommandTimeout")}).click();
        ...
        cy.wait('@getCustomPolicies', {timeout: Cypress.config("defaultCommandTimeout")}).then(() => {
