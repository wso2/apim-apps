...
describe("Add production sandbox endpoints for SOAP", () => {
    ...
    it.only("Add production sandbox endpoints for SOAP", () => {
        Utils.addAPI({}).then((apiId) => {
            ...
            cy.get('[data-testid="http/soapendpoint-add-btn"]', {timeout: Cypress.config("defaultCommandTimeout")}).click();
            ...
            cy.get('#endpoint-save-btn', {timeout: Cypress.config("defaultCommandTimeout")}).click();
