...
describe("Publish thirdparty api", () => {
    ...
    it.only("Publish thirdparty api", {
        ...
        publisherComonPage.waitUntillPublisherLoadingSpinnerExit();
            ...
            // publisherComonPage.waitUntillPublisherLoadingSpinnerExit();
            // cy.get('#outlined-full-width', {timeout: Cypress.config("defaultCommandTimeout")}).invoke('val',
            ...
            cy.url().then(url => {
                ...
                cy.wait(1000);
                cy.get('[data-testid="Publish-btn"]', {timeout: Cypress.config("defaultCommandTimeout")}).should('exist');
                ...
                // cy.get('[data-testid="itest-update-api-confirmation"]', {timeout: Cypress.config("defaultCommandTimeout")}).
                //     should('exist');
                ...
                cy.get(`div[data-testid="card-${apiName}1.0.0"]`, { timeout: Cypress.config("defaultCommandTimeout") })
