...
describe("Gateway Policies", () => {
    ...
    it("Global Policy Operations", () => {
        // Add policy mapping
        cy.visit(`publisher/global-policies/create`, { timeout: Cypress.config("defaultCommandTimeout") });
        ...
        cy.contains('Add Header', { timeout: Cypress.config("defaultCommandTimeout") }).trigger('dragstart', {
            dataTransfer
        });
        ...
        cy.visit(`publisher/global-policies`, { timeout: Cypress.config("defaultCommandTimeout") });
        ...
        cy.get('[data-testid=deploy-to-gateway-button]', { timeout: Cypress.config("defaultCommandTimeout") }).click();
        ...
        cy.get('#headerValue', { timeout: Cypress.config("defaultCommandTimeout") }).click();
        ...
        cy.get(`#gateway-chip-${gateway} svg[class*=MuiChip-deleteIcon]`)
            .should('be.visible')
            .click();
        cy.get('[data-testid=undeploy-from-gateway-button]', { timeout: Cypress.config("defaultCommandTimeout") })
            .should('be.visible')
            .click();
        ...
        cy.get('[data-testid=policy-mapping-delete-confirmation-button]', { timeout: Cypress.config("defaultCommandTimeout") }).click();
