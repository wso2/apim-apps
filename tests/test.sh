...
tar -xvf node-v22.22.1-linux-x64.tar.xz
sudo ln -sf $HOME/node-v22.22.1-linux-x64/bin/node /usr/bin/node
sudo ln -sf $HOME/node-v22.22.1-linux-x64/bin/npm /usr/bin/npm
sudo ln -sf $HOME/node-v22.22.1-linux-x64/bin/npx /usr/bin/npx
